 ...
 */
public class Jboss4Detector {

    private static final String DEFAULT_EXPECTED_MAIN_CLASS = "org.jboss.Main";

    private final List<String> expectedMainClasses;

    public Jboss4Detector(List<String> expectedMainClasses) {
